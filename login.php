	...
	<div class="login-box">
		...
		<div class="card">
			<div class="card-body login-card-body">
				...
				<center>
					<img src="tampilan/image/login.png" width=250px />
					<br>
					<br>
				</center>
		...
		<!-- Alert -->
		<script src="tampilan/plugins/alert.js"></script>
...
if (isset($_POST['btnLogin'])) {  
	...
	//query login
	$sql_login = "SELECT * FROM users WHERE BINARY username='$username' AND password='$password'";
