    ...
    <div class="container"> <!--container-->
            ...
            <table class="table table-striped table-bordered table-hover">
              ...
              <tbody>
                ...
                foreach ($data as $nama => $krit) {
                  ...
                  array_push($sorting, $resData);
                }

              usort($sorting, function($a, $b)
              {
                  return strcmp($b->hasil, $a->hasil);
              });
                ...
                foreach ($sorting as $key => $value) {
                  ...
                  echo "<tr>
                            <td>" . ($key+1) . "</td>
                            <th>{$value->alternatif}</th>
                            <td>{$value->nama}</td>";
                  echo "<td>{$value->hasil}</td></tr>\n";
                }
                ?>
              </tbody>
            </table>
      ...
      <div class="row">
        <div class="col-lg-8 col-lg-offset-2">
          <div class="panel panel-default">
            <div class="panel-heading">
              Nilai Preferensi Tertinggi(V<sub>i</sub>)
            </div>
            <div class="panel-body">
              <table class="table table-striped table-bordered table-hover">
                <thead>
                  <tr>
                    <th> Nilai terpilih adalah </th>
                    <th>
                      <?= array_keys($rangking, max($rangking))[0] ?>
                    </th>
                    <th>
                      <?php
                      echo max($V);
